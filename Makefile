#############################################################################
# Makefile for building: WaveCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.2) on: Sun Jun 15 06:19:21 2014
# Project:  wavecoin-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=- -o Makefile wavecoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu /root/Desktop/wavecoin/src/leveldb/libleveldb.a /root/Desktop/wavecoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
$(TARGET): /root/Desktop/wavecoin/src/leveldb/libleveldb.a /root/Desktop/wavecoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: wavecoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile wavecoin-qt.pro
...
/root/Desktop/wavecoin/src/leveldb/libleveldb.a: FORCE
	cd /root/Desktop/wavecoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/Desktop/wavecoin/build/build.h: FORCE
	cd /root/Desktop/wavecoin; /bin/sh share/genbuild.sh /root/Desktop/wavecoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/WaveCoin-256.png \
		src/qt/res/icons/clock4.png \
		src/qt/res/icons/clock5.png \
		src/qt/res/icons/qrcode.png \
		src/qt/res/icons/WaveCoin-16.png \
		src/qt/res/icons/WaveCoin.png \
